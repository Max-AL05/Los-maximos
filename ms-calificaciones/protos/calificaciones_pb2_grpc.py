...
class CalificacionesServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPromedioAlumno = channel.unary_unary(
                ...
                response_deserializer=calificaciones__pb2.GetPromedioAlumnoResponse.FromString,
                _registered_method=True)
        self.GetEstadisticasMateria = channel.unary_unary(
                ...
                response_deserializer=calificaciones__pb2.GetEstadisticasMateriaResponse.FromString,
                _registered_method=True)
...
def add_CalificacionesServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetPromedioAlumno': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=calificaciones__pb2.GetPromedioAlumnoResponse.SerializeToString,
            ),
            'GetEstadisticasMateria': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=calificaciones__pb2.GetEstadisticasMateriaResponse.SerializeToString,
            ),
    }
...
class CalificacionesService(object):
    ...
    def GetPromedioAlumno(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            calificaciones__pb2.GetPromedioAlumnoResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetEstadisticasMateria(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            calificaciones__pb2.GetEstadisticasMateriaResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
