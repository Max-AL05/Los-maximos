"""
Configuración Django para el microservicio ms-reportes.
Variables sensibles se leen desde .env
"""
...
# === gRPC — targets de otros microservicios ===
GRPC_TARGETS = {
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Generación de reportes Excel/PDF y estadísticas históricas del sistema AGM",
    "VERSION":     "1.0.0",
